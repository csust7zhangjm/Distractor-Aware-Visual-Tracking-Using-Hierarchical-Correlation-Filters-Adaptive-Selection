function [results,time] = trackerMain2_wy980_cov5_1_2_3_4(p, im, bg_area, fg_area, area_resize_factor)
...
%        responseHandLow = mexResize(response_cf, p.norm_delta_area,'auto');
      ...
      responseDeepadd = cropFilterResponse(response_deep{3}, floor_odd(p.norm_delta_area / p.hog_cell_size));
      responseDeepadd = mexResize(responseDeepadd, p.norm_delta_area,'auto');
      ...
      expert(4).response = responseDeepadd;
