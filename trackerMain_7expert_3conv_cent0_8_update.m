        ...
        %     aaa=expert(i).RobScore(frame)
         ...
         meanScore(frame) = sum(IDensemble)/expertNum; 
          ...
          if frame==163
              ...
              y6=sco(:,6);
              y7=sco(:,7);
              plot(x,y1,'y','LineWidth',2);axis([0,m,0,20]);set(gca,'XTick',[0:20:m]);set(gca,'YTick',[0:5:20])
              hold on;
              plot(x,y2,'k','LineWidth',2);axis([0,m,0,20]);set(gca,'XTick',[0:20:m]);set(gca,'YTick',[0:5:20])
              hold on;
              plot(x,y3,'b','LineWidth',2);axis([0,m,0,20]);set(gca,'XTick',[0:20:m]);set(gca,'YTick',[0:5:20])
              hold on;
              plot(x,y4,'m','LineWidth',2);axis([0,m,0,20]);set(gca,'XTick',[0:20:m]);set(gca,'YTick',[0:5:20])
              hold on;
              plot(x,y5,'c','LineWidth',2);axis([0,m,0,20]);set(gca,'XTick',[0:20:m]);set(gca,'YTick',[0:5:20])
              hold on;
              plot(x,y6,'g','LineWidth',2);axis([0,m,0,20]);set(gca,'XTick',[0:20:m]);set(gca,'YTick',[0:5:20])
              hold on;
              plot(x,y7,'r','LineWidth',2);axis([0,m,0,20]);set(gca,'XTick',[0:20:m]);set(gca,'YTick',[0:5:20])
              legend('Response ¢ñ','Response ¢ò','Response ¢ó','Response ¢ô',' Response ¢õ','Response ¢ö','Response ¢÷');
              set(gca,'LooseInset',get(gca,'TightInset'))
              xlabel('Frame');
              ylabel('Normalized Robustness Score');
              set(gca,'Box','on')
          end
